...
class Label(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("job_id", "name", name="uq_labels_job_name"),
    )
    ...
    project: Mapped[Project | None] = relationship(back_populates="labels")
    job: Mapped[Job | None] = relationship(back_populates="labels")
